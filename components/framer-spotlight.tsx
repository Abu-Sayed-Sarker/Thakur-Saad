...
export default function FramerSpotlight() {
  ...
  const spotlightColors = [
    { color: "rgba(16, 185, 129, 0.2)", darkColor: "rgba(16, 185, 129, 0.25)" }, // Emerald (primary)
    { color: "rgba(20, 184, 166, 0.15)", darkColor: "rgba(20, 184, 166, 0.2)" }, // Teal
    { color: "rgba(34, 197, 94, 0.15)", darkColor: "rgba(34, 197, 94, 0.2)" }, // Green
  ];
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background: `radial-gradient(circle, ${
            isDark ? "rgba(5, 150, 105, 0.2)" : "rgba(5, 150, 105, 0.15)"
          } 0%, transparent 70%)`,
          width: "600px",
          height: "600px",
          borderRadius: "50%",
      ...
      <motion.div
        ...
        style={{
          background: `radial-gradient(circle, ${
            isDark ? "rgba(13, 148, 136, 0.2)" : "rgba(13, 148, 136, 0.15)"
          } 0%, transparent 70%)`,
          width: "550px",
          height: "550px",
          borderRadius: "50%",
